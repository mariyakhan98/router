        ...
        <div class="row h-100">
            <div class="col-md-12">
                <form class="border h-100 mt-3 ">
                    ...
                    <div class="row mt-3 ps-4 pe-4">
                        <div class="col-md-4">
                            <h6>Landscape Marketing Image (1.9.:1)</h6>
                         <input type="email" class="form-control " id="exampleFormControlInput1" placeholder="Add the URL of the Image you want to use for the ad"/>
                        </div>
                        <div class="col-md-4">
                            <h6>Portrait Marketing (4:5)</h6>
                         <input type="email" class="form-control " id="exampleFormControlInput1" placeholder="Add the URL of the Image you want to use for the ad"/>
                        </div>
                        <div class="col-md-4">
                            <h6>Square Marketing Image (1:1)</h6>
                         <input type="email" class="form-control " id="exampleFormControlInput1" placeholder="Add the URL of the Image you want to use for the ad"/>
                        </div>
                    </div>
                    <div class="row mt-3 ps-4 pe-4">
